...
use uuid::Uuid;
use crate::models::{Client, Address, Animal, Race, Event, Seminar};
...
pub trait ClientRepository: Send + Sync {
    ...
    async fn save(&self, client: Client) -> Result<Client, crate::Error>;
...
pub trait AddressRepository: Send + Sync {
    ...
    async fn save(&self, address: Address) -> Result<Address, crate::Error>;
    async fn delete(&self, id: Uuid) -> Result<(), crate::Error>;
}
...
pub trait AnimalRepository: Send + Sync {
    ...
    async fn save(&self, animal: Animal) -> Result<Animal, crate::Error>;
    async fn delete(&self, id: Uuid) -> Result<(), crate::Error>;
}
...
pub trait RaceRepository: Send + Sync {
    ...
    async fn save(&self, race: Race) -> Result<Race, crate::Error>;
    async fn delete(&self, id: Uuid) -> Result<(), crate::Error>;
}
...
pub trait EventRepository: Send + Sync {
    ...
    async fn save(&self, event: Event) -> Result<Event, crate::Error>;
    async fn delete(&self, id: Uuid) -> Result<(), crate::Error>;
}
...
pub trait SeminarRepository: Send + Sync {
    ...
    async fn save(&self, seminar: Seminar) -> Result<Seminar, crate::Error>;
    async fn delete(&self, id: Uuid) -> Result<(), crate::Error>;
}
