...
const EventDetailItem = observer(({ event }: { event: Event }) => {
    ...
    <div className="w-full flex flex-col md:flex-row justify-between">
      <div className="flex-col">
        ...
        <div>
          ...
          {participants
            .map((participation) => participation.cost)
      ...
      <div className="flex-col">
        ...
        <div className="md:text-right">
          ...
          {!!event.location.extra && `, ${event.location.extra}`}
        </div>
        <div className="md:text-right">
          {`${event.location.postalCode}, ${event.location.city}`}
        </div>
        <div className="md:text-right">{`${event.location.country}`}</div>
      </div>
    </div>
  );
});
