...
import {
  askEditEventParticipation,
  submitDeleteEventParticipation,
} from "./index";

const ClientParticipation = observer(
  ({ participation }: { participation: EventParticipation }) => {
        ...
        <div className="self-center dropdown dropdown-left group-last:dropdown-end group-last:dropdown-left">
          ...
          >
            ...
            <li>
              <a
                onClick={(e) =>
                  askEditEventParticipation(participation, updateState)
                }
                className={
            ...
            <li>
              <a
                onClick={(e) =>
                  submitDeleteEventParticipation(participation, deleteState)
                }
                className={
