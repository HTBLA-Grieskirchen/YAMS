...
const MainNavbar = observer(
  ({
    ...
    children: ReactNode;
    NavbarPath: () => ReactElement;
    NavbarMenu: () => ReactElement;
  }) => {
    return (
      <>
        <Navbar
          isBordered
          className="bg-background/70 backdrop-blur-md sticky top-0 z-40"
          maxWidth="full"
        >
...
export const NavbarMenuEntry = observer(
  ({ disabled, children }: { disabled?: boolean; children?: ReactNode }) => {
    return (
      <NavbarItem
        isActive={!disabled}
