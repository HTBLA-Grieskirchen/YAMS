          ...
          <tr>
            <td colSpan={100}>
              <div className="bg-base-300 font-normal rounded-box p-2 w-[42rem] ">
                <p className="font-bold text-xs">FURTHER INFORMATION:</p>
                <div className="flex flex-col mb-1 w-fit">
                  <p>
                    <i className="fa-solid fa-paper-plane mr-1" />
                    <a
                      className="font-normal text-base min-w-full xl:max-w-4xl sm:max-w-sm max-w-0 truncate underline decoration-blue-700 text-blue-700 hover:no-underline hover:text-blue-600"
                ...
                <p className="text-xs mb-1">REGISTERED ANIMALS:</p>
