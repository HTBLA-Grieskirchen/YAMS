...
const ProductTypeUsageTabs = observer((
    {productType}:
    ...
    return <div className="flex flex-col">
        ...
        <div className={`transition-all ${expanded ? "h-fit" : "h-0"} overflow-clip`}>
            <Tabs value={"client"} id={`${productType.name}_usages`} className="mt-2">
                ...
                <TabsBody>
                    <TabPanel value={"client"}>
                        <ClientContent productType={productType}/>
                    </TabPanel>
                    <TabPanel value={"event"}>
                        <EventContent productType={productType}/>
                    </TabPanel>
                </TabsBody>
            </Tabs>
        </div>
...
export default ProductTypeUsageTabs
