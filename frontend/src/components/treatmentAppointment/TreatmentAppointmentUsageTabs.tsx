...
const TreatmentAppointmentUsageTabs = observer((
    ...
    return <div className="flex flex-col">
        ...
        <div className={`transition-all ${expanded ? "h-fit" : "h-0"} overflow-clip`}>
            <Tabs value={"client"} id={`${treatmentAppointment.record.join()}_usages`} className="mt-2">
                ...
                <TabsBody>
                    <TabPanel value={"client"}>
                        <ClientContent treatmentAppointment={treatmentAppointment}/>
                    </TabPanel>
                    <TabPanel value={"event"}>
                        <EventContent treatmentAppointment={treatmentAppointment}/>
                    </TabPanel>
                </TabsBody>
            </Tabs>
        </div>
...
export default TreatmentAppointmentUsageTabs
