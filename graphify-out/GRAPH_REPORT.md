...
## Corpus Check
- 313 files · ~351,821 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3414 nodes · 8638 edges · 175 communities (137 shown, 29 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 235 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1e594826`
...
### Community 13 - "termin-detail-panel.tsx"
Cohesion: 0.05
Nodes (43): useSeminarBuchungAnlegenMutation(), useSeminarBuchungStornierenMutation(), useSeminarTerminAbgehaltenMutation(), useSeminarTerminAbsagenMutation(), useSeminarUmsatzVorschauQuery(), components, $defs, LeistungQuelle_LeistungQuelleBehandlungTyp (+35 more)
...
### Community 35 - "RechnungId"
Cohesion: 0.10
Nodes (24): Abgerechnet, behandlung_betrag_uses_snapshot_preis(), Leistung, leistung_rejects_empty_beschreibung(), LeistungAbgerechnet, LeistungFehler, LeistungIn, LeistungQuelle (+16 more)
...
### Community 65 - "cn"
Cohesion: 0.09
Nodes (29): KatalogTab, TabButton(), KlientTable(), KlientTableRow(), RowActionsMenuProps, SeminarOverview(), statusBadgeVariant(), TerminFilter (+21 more)
...
Cohesion: 0.11
Nodes (37): HaustierCreateFormProps, KlientDetailProps, KlientRegisterFormProps, Alert(), AlertProps, AlertVariant, variantClasses, Button() (+29 more)
...
Cohesion: 0.15
Nodes (15): UseCase, BehandlungErstellen, ProduktErstellen, Behandlung, Produkt, HaustierErstellen, HaustierErstellenFehler, Context (+7 more)

### Community 92 - "SeminarTerminId"
Cohesion: 0.08
Nodes (37): abgehalten_use_case(), SeminarTerminAbsage, Uuid, SeminarTerminId, teilnahme_key_nests_termin_and_buchung(), buchung_umsatz(), BuchungUmsatz, NaiveDate (+29 more)

### Community 100 - "SQLiteInstance"
Cohesion: 0.17
Nodes (17): AtomicBool, InstanceType, Arc, AsRef, Connection, Deref, Mutex, Path (+9 more)

### Community 101 - "Client"
Cohesion: 0.09
...
Cohesion: 0.09
Nodes (44): useBehandlungErstellenMutation(), useHaustierErstellenMutation(), useKlientErstellenMutation(), useLeistungAusBehandlungBuchenMutation(), useLeistungAusProduktBuchenMutation(), useLeistungManuellErfassenMutation(), useProduktErstellenMutation(), useSeminarErstellenMutation() (+36 more)
...
Cohesion: 0.23
Nodes (11): useSeminarTerminPlanenMutation(), TerminPlanForm(), handleSubmit(), TerminPlanFormProps, Select(), SelectProps, defaultTermin(), SeminarTerminForm() (+3 more)
...
### Community 172 - "parse_datetime"
Cohesion: 0.67
Nodes (4): format_datetime(), parse_datetime(), DateTime, Utc

## Knowledge Gaps
- **291 isolated node(s):** `molting`, `ValidationError`, `RechnungFehler`, `ProduktErstellenFehler`, `BehandlungErstellenFehler` (+286 more)
...
- **Why does `String` connect `String` to `TestError`, `.haustier_erstellen`, `in_memory_object_store.rs`, `src-tauri/src/config.rs`, `termin_from_parts`, `InternalServerError`, `LeistungId`, `Behandlung`, `FakeUnitOfWork`, `domain/kontakt.rs`, `parse_position_from_row`, `document_text`, `SeminarId`, `tests.rs`, `leistung_from_row`, `LeistungOffen`, `EmailAdresse`, `Rechnungsposition`, `KlientId`, `RechnungId`, `ObjectStore`, `requests/seminar.rs`, `domain/adresse.rs`, `schema/leistung.rs`, `parse_datetime`, `common.rs`, `Klientbericht`, `base_app_builder`, `Seminar`, `HaustierErstellung`, `Produkt`, `StructuredError`, `Json`, `base_app_builder`, `schema/seminar.rs`, `Adresse`, `Menge`, `UseCase`, `SeminarTerminId`, `server/src/config.rs`, `.behandlung_erstellen`, `Klient`, `.produkt_erstellen`, `HaustierId`, `KlientErstellen`, `KlientErstellung`, `Rechnung`, `v0004_leistungen_quelle_mwst.rs`?**
