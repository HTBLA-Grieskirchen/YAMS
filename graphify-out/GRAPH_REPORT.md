...
## Corpus Check
- 279 files · ~342,361 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3214 nodes · 8017 edges · 170 communities (133 shown, 28 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 230 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `273ec564`
...
Cohesion: 0.05
Nodes (23): CompatibilityResult, db, live(), LiveCleaner, LoadingResult, QueryResultState, TODO: Provide live support once sync is implemented, TODO: Remove once sync is implemented (+15 more)

### Community 24 - "tests.rs"
Cohesion: 0.19
Nodes (35): Rechnungspositionsbericht, adresse(), assert_absent(), assert_contains(), assert_valid_pdf(), generate(), hof_adresse(), klient() (+27 more)

### Community 25 - "domain/seminar_termin.rs"
Cohesion: 0.30
...
Cohesion: 0.08
Nodes (26): AnimalAddItem, AnimalComboBox, patchAnimal(), deleteRace(), patchRace(), createSeminar(), ensureSeminar(), Address (+18 more)

### Community 27 - ".from_parts"
Cohesion: 0.16
Nodes (12): Abgehalten, Abgesagt, DateTime, From, FxHashMap, Into, Utc, SeminarBuchungStatus (+4 more)

### Community 28 - "_app.tsx"
Cohesion: 0.10
...
Cohesion: 0.14
Nodes (19): Abgerechnet, Leistung, leistung_rejects_empty_beschreibung(), LeistungAbgerechnet, LeistungFehler, LeistungId, LeistungIn, LeistungQuelle (+11 more)
...
Cohesion: 0.17
Nodes (20): ObjectStore, Send, Sync, mit_objekt_rollback(), nach_pdf_persistieren(), objekt_löschen_best_effort(), pdfs_rendern_und_ablegen(), rechnung_key_uses_uuid() (+12 more)
...
Cohesion: 0.16
Nodes (11): Address, BackendClient, getBackendClient(), HttpBackendClient, TauriBackendClient, useAddresses(), useBackend(), AddressTableHeader (+3 more)
...
Cohesion: 0.15
Nodes (27): PdfRenderError, adresse_dict(), compile_paged(), decimal(), klient_dict(), menge(), naive_date(), praxis_dict() (+19 more)
...
Cohesion: 0.10
Nodes (17): DateTime, NaiveDate, Utc, SystemClock, ExecutionContext, ExecutionContext<'a>, Arc, RepositoryResult (+9 more)
...
Cohesion: 0.06
Nodes (43): AddressEditTableRowContent, AddressTableRow, AddressUsageInfo, AddressViewTableRowContent, ClientUsages, EditButton, EditButtons, EditState (+35 more)
...
Cohesion: 0.18
Nodes (13): SeminarTerminAbsage, seminar_betrag_full_rabatt_is_zero(), seminar_betrag_uses_nach_rabatt(), SeminarTerminId, UseCase, teilnahme_key_nests_termin_and_buchung(), SeminarOrt, SeminarTermin (+5 more)
...
### Community 145 - "SeminarBuchungId"
Cohesion: 0.18
Nodes (8): Item, Iterator, Self, Seminar, Uuid, SeminarBuchung, SeminarBuchungId, SeminarBuchungStatus
...
### Community 153 - "SeminarTerminGeplant"
Cohesion: 0.33
Nodes (4): ResultReport, SeminarTerminFehler, SeminarTerminGeplant, SeminarTerminPlanen
...
### Community 168 - "SeminarErstellen"
Cohesion: 0.50
...
- **Why does `String` connect `String` to `arc_up`, `main`, `SeminarId`, `.haustier_erstellen`, `in_memory_object_store.rs`, `YAMSFrontendConfig`, `termin_from_parts`, `InternalServerError`, `SeminarTerminId`, `Behandlung`, `FakeUnitOfWork`, `domain/kontakt.rs`, `parse_position_from_row`, `document_text`, `tests.rs`, `parse_datetime`, `.from_parts`, `LeistungOffen`, `EmailAdresse`, `Klient`, `LeistungId`, `ObjectStore`, `SeminarErstellen`, `requests/seminar.rs`, `domain/adresse.rs`, `schema/leistung.rs`, `BehandlungErstellen`, `leistung_from_row`, `PdfDokument`, `base_app_builder`, `Seminar`, `HaustierErstellung`, `Produkt`, `StructuredError`, `Json`, `base_app_builder`, `schema/seminar.rs`, `Rechnungsposition`, `HaustierErstellen`, `Adresse`, `requests/abrechnung.rs`, `common.rs`, `ExecutionContext`, `.behandlung_erstellen`, `Klient`, `.produkt_erstellen`, `KlientId`, `KlientErstellen`, `Menge`, `KlientErstellung`, `Rechnung`, `v0004_leistungen_quelle_mwst.rs`?**
