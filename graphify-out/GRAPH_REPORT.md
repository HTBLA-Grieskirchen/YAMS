...
## Corpus Check
- 319 files · ~353,674 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3444 nodes · 8773 edges · 172 communities (138 shown, 25 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 235 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca7089e4`
...
Cohesion: 0.08
Nodes (23): components, $defs, LeistungQuelle_LeistungQuelleBehandlungTyp, Behandlung, LeistungQuelle_LeistungQuelleManuellTyp, Manuell, LeistungQuelle_LeistungQuelleProduktTyp, Produkt (+15 more)
...
Cohesion: 0.14
Nodes (19): createYamsApi(), getYamsApi(), normalizeApiBaseUrl(), resetYamsApiCache(), useYamsApi(), YamsApiContext, YamsApiContextValue, YamsApiProvider() (+11 more)

### Community 19 - "domain/kontakt.rs"
Cohesion: 0.10
Nodes (18): Adresse, domain::Adresse, Ländercode, Example, From, Self, TryFrom, email_accepts_valid_address() (+10 more)
...
Cohesion: 0.12
Nodes (10): Clone, Deref, Formatter, Option, Self, Target, Versioned<T>, Ordering (+2 more)
...
Cohesion: 0.13
Nodes (19): LeistungOffen, BehandlungErstellen, BehandlungErstellenFehler, LeistungAusBehandlungBuchen, LeistungAusBehandlungBuchenFehler, LeistungAusProduktBuchen, LeistungAusProduktBuchenFehler, LeistungManuellErfassen (+11 more)
...
Cohesion: 0.13
Nodes (13): blank_renderer_returns_pdf_prefix(), BlankPdfRenderer, dummy_rechnung(), ResultReport, Vec, PdfDokument, FakePdfRenderer, Arc (+5 more)

### Community 37 - "ObjectStore"
Cohesion: 0.21
Nodes (18): ObjectStore, Send, Sync, mit_objekt_rollback(), nach_pdf_persistieren(), objekt_löschen_best_effort(), pdfs_rendern_und_ablegen(), rechnung_object_key() (+10 more)

### Community 38 - "Uuid"
Cohesion: 0.10
Nodes (18): ObjectStoreError, ObjectStream, Self, SeminarBuchungErstellung, SeminarTermin, SeminarTerminAbsage, SeminarTerminAktualisierung, SeminarTerminErstellung (+10 more)
...
### Community 44 - "ResultReport"
Cohesion: 0.11
Nodes (18): AuflistenFehler, Behandlung, Haustier, HaustierErstellung, Klient, KlientErstellung, Produkt, Rechnung (+10 more)

### Community 45 - "FakeDatastore"
Cohesion: 0.11
Nodes (16): FakeBehandlungenRepository, FakeDatastore, FakeLeistungenRepository, FakeRechnungenRepository, Arc, Behandlung, Clone, Default (+8 more)
...
Cohesion: 0.25
Nodes (17): menge_to_str(), parse_decimal(), parse_haustier_id(), parse_klient_id(), parse_menge(), parse_preis(), parse_ratio(), parse_rechnung_id() (+9 more)
...
Cohesion: 0.08
Nodes (10): BehandlungRepository, HaustierRepository, ProduktRepository, RechnungRepository, RepositoryError, Option, Send, Sync (+2 more)
...
Cohesion: 0.10
Nodes (7): Menge, MengeFehler, Decimal, Self, position_from_leistung(), RechnungIn<S>, Rechnungsposition

### Community 65 - "cn"
Cohesion: 0.07
Nodes (47): RechnungStatus, Bezahlt, Offen, Rechnung, KatalogTab, TabButton(), formatEuroSum(), KlientLeistungenSection() (+39 more)
...
Cohesion: 0.12
Nodes (35): TerminBuchungFormProps, TerminDetailPanelProps, Alert(), AlertProps, AlertVariant, variantClasses, Button(), ButtonProps (+27 more)
...
Cohesion: 0.12
Nodes (15): ApiError, JsonClient, Adresse, Behandlung, BehandlungErstellung, Klient, KlientErstellung, Produkt (+7 more)
...
Cohesion: 0.10
Nodes (35): SeminarTerminId, UseCase, teilnahme_key_nests_termin_and_buchung(), buchung_umsatz(), BuchungUmsatz, NaiveDate, Option, Report (+27 more)
...
Cohesion: 0.07
Nodes (47): useBehandlungErstellenMutation(), useLeistungAusBehandlungBuchenMutation(), useLeistungAusProduktBuchenMutation(), useLeistungManuellErfassenMutation(), useProduktErstellenMutation(), useSeminarBuchungAnlegenMutation(), useSeminarBuchungStornierenMutation(), useSeminarErstellenMutation() (+39 more)
...
Cohesion: 0.36
Nodes (6): BehandlungErstellenFehler, BehandlungErstellung, Behandlung, Decimal, Uuid, schema_behandlung_from_domain()
...
Cohesion: 0.32
Nodes (6): ProduktErstellung, Produkt, Decimal, Uuid, schema_produkt_from_domain(), ProduktErstellenFehler
...
Cohesion: 0.12
Nodes (21): AppChrome(), AppShell(), PageChromeContext, PageChromeContextValue, PageChromeProvider(), SetBreadcrumbLabel(), usePageChrome(), Sidebar() (+13 more)
...
Cohesion: 0.20
Nodes (10): Versioned, FakeHaustiereRepository, FakeKlientenRepository, FakeSeminarTermineRepository, Haustier, Klient, Rechnung, RepositoryResult (+2 more)
...
Cohesion: 0.20
Nodes (10): Box, C, F, Future, Output, Report, RepositoryResult, T (+2 more)
...
### Community 127 - "klient-detail.tsx"
Cohesion: 0.11
Nodes (14): useHaustierErstellenMutation(), useRechnungenFürKlientQuery(), KlientDetailContent(), emptyHaustier(), HaustierCreateForm(), handleSubmit(), HaustierCreateFormProps, KlientDetail() (+6 more)
...
Cohesion: 0.15
Nodes (17): LeistungId, Abgehalten, Abgesagt, DateTime, FxHashMap, Into, ResultReport, Utc (+9 more)
...
### Community 154 - "wal_connection_race.rs"
Cohesion: 0.70
...
Cohesion: 0.14
Nodes (16): RechnungDownloadButton(), handleDownload(), RechnungDownloadButtonProps, downloadTeilnahmePdf(), TerminPlanForm(), handleSubmit(), TerminPlanFormProps, Select() (+8 more)

### Community 159 - "SeminarBuchungForm"
Cohesion: 1.00
...
## Knowledge Gaps
- **299 isolated node(s):** `molting`, `ValidationError`, `RechnungFehler`, `ProduktErstellenFehler`, `BehandlungErstellenFehler` (+294 more)
...
- **Why does `String` connect `String` to `TestError`, `Haustier`, `in_memory_object_store.rs`, `src-tauri/src/config.rs`, `termin_from_parts`, `InternalServerError`, `LeistungId`, `Behandlung`, `FakeUnitOfWork`, `domain/kontakt.rs`, `parse_position_from_row`, `document_text`, `SeminarId`, `tests.rs`, `leistung_from_row`, `LeistungOffen`, `EmailAdresse`, `KlientId`, `NeueLeistung`, `ObjectStore`, `requests/seminar.rs`, `domain/adresse.rs`, `schema/leistung.rs`, `common.rs`, `Klientbericht`, `base_app_builder`, `Seminar`, `HaustierErstellung`, `Produkt`, `StructuredError`, `Json`, `base_app_builder`, `schema/seminar.rs`, `Rechnungsposition`, `requests/abrechnung.rs`, `HaustierErstellen`, `SeminarTerminId`, `teilnahme_dokument`, `server/src/config.rs`, `.behandlung_erstellen`, `Klient`, `.produkt_erstellen`, `HaustierId`, `KlientErstellen`, `KlientErstellung`, `Rechnung`, `v0004_leistungen_quelle_mwst.rs`?**
