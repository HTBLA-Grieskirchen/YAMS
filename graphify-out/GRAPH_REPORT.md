...
## Corpus Check
- 270 files · ~334,351 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2960 nodes · 7215 edges · 150 communities (123 shown, 18 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 227 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5a48ed75`
...
Cohesion: 0.12
Nodes (11): Clone, Deref, Formatter, Option, Self, T, Target, Versioned<T> (+3 more)

### Community 22 - "Versioned"
Cohesion: 0.15
Nodes (11): Versioned, FakeHaustiereRepository, FakeKlientenRepository, FakeSeminarTermineRepository, Haustier, Klient, NaiveDate, RepositoryResult (+3 more)
...
Cohesion: 0.15
Nodes (14): LeistungAbgerechnet, LeistungOffen, BehandlungErstellenFehler, LeistungAusBehandlungBuchen, LeistungAusBehandlungBuchenFehler, LeistungAusProduktBuchen, LeistungAusProduktBuchenFehler, LeistungManuellErfassen (+6 more)
...
Cohesion: 0.16
Nodes (25): aus_leistungen_maps_seminar_quelle(), aus_leistungen_rejects_klient_mismatch(), aus_leistungen_skips_already_abgerechnet(), Bezahlt, leistung_offen(), mwst_19(), Offen, position() (+17 more)
...
Cohesion: 0.11
Nodes (20): Abgerechnet, behandlung_betrag_uses_snapshot_preis(), Leistung, leistung_rejects_empty_beschreibung(), LeistungFehler, LeistungIn, mark_abgerechnet_sets_rechnung_id(), NeueLeistung (+12 more)
...
Cohesion: 0.12
Nodes (19): FakeBehandlungenRepository, FakeDatastore, FakeLeistungenRepository, FakeProdukteRepository, FakeRechnungenRepository, FakeSeminareRepository, Arc, Behandlung (+11 more)
...
Cohesion: 0.18
Nodes (11): NeuesSeminar, preis(), Into, Option, ResultReport, Self, TimeDelta, Uuid (+3 more)
...
### Community 56 - "Ratio"
Cohesion: 0.12
Nodes (9): LeistungQuelle, Ratio, RatioFehler, Decimal, Self, BehandlungErstellen, ProduktErstellen, Behandlung (+1 more)
...
Cohesion: 0.09
Nodes (18): BehandlungRepository, HaustierRepository, KlientRepository, LeistungRepository, ProduktRepository, RechnungRepository, RepositoryError, Option (+10 more)
...
Cohesion: 0.07
Nodes (46): abgehalten_use_case(), SeminarTerminId, UseCase, teilnahme_key_nests_termin_and_buchung(), HaustierErstellen, HaustierErstellenFehler, Context, Haustier (+38 more)
...
Cohesion: 0.09
Nodes (15): LockedUnitOfWorkImpl, Box, C, F, Future, Output, Report, RepositoryResult (+7 more)
...
### Community 121 - "RechnungOffen"
Cohesion: 0.60
Nodes (4): RechnungOffen, rechnung_object_key(), Vec, TagesabschlussDurchführen
...
### Community 127 - ".begin"
Cohesion: 0.28
Nodes (6): Box, RepositoryError, RepositoryResult, ResultReport, Self, SQLiteInstance
...
Cohesion: 0.11
Nodes (34): LeistungId, seminar_accepts_titel_and_rabatt(), seminar_rejects_empty_titel(), Abgehalten, Abgesagt, absagen_archives_buchungen(), als_abgehalten_maps_all_confirmed(), als_abgehalten_maps_confirmed_only() (+26 more)
...
Cohesion: 0.23
Nodes (17): ObjectStore, Send, Sync, mit_objekt_rollback(), nach_pdf_persistieren(), objekt_löschen_best_effort(), pdfs_rendern_und_ablegen(), rechnung_pdf_laden() (+9 more)
...
### Community 138 - "wal_connection_race.rs"
Cohesion: 0.70
...
### Community 140 - "Option"
Cohesion: 0.13
Nodes (15): aktualisieren_rejects_max_below_confirmed(), Geplant, NeuerSeminarTermin, Adresse, From, Option, S, Self (+7 more)
...
### Community 153 - ".seminar_umsatz_prognose"
Cohesion: 0.50
...
- **Why does `String` connect `String` to `arc_up`, `openapi_service`, `LeistungId`, `.haustier_by_id`, `ObjectStore`, `YAMSFrontendConfig`, `termin_from_parts`, `InternalServerError`, `Option`, `Behandlung`, `FakeUnitOfWork`, `domain/kontakt.rs`, `parse_position_from_row`, `document_text`, `tests.rs`, `LeistungOffen`, `EmailAdresse`, `KlientId`, `NeueLeistung`, `in_memory_object_store.rs`, `requests/seminar.rs`, `domain/adresse.rs`, `schema/leistung.rs`, `KlientErstellen`, `leistung_from_row`, `Klientbericht`, `base_app_builder`, `SeminarId`, `HaustierErstellung`, `Produkt`, `Ratio`, `StructuredError`, `Json`, `base_app_builder`, `schema/seminar.rs`, `Preis`, `teilnahme_dokument`, `Adresse`, `requests/abrechnung.rs`, `common.rs`, `SeminarTerminId`, `.behandlung_erstellen`, `Klient`, `.produkt_erstellen`, `HaustierId`, `KlientErstellung`, `Rechnung`, `RechnungOffen`, `v0004_leistungen_quelle_mwst.rs`?**
  _High betweenness centrality (0.521) - this node is a cross-community bridge._
- **Why does `NotificationType` connect `NotificationType` to `useStore`, `notification.ts`?**
